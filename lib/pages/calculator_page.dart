...
class _CalculatorPageState extends State<CalculatorPage> {
  ...
  final _color = [Colors.blueAccent, Colors.purpleAccent];
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    _buildDateInputField(
                      'Data de pagamento',
                      controller: _controller.payDateController,
                      onSaved: (date) {
  ...
  _buildDateInputField(String label,
      {TextEditingController controller, Function(DateTime) onSaved}) {
    return Container(
      height: _inputFieldHeight,
      padding: EdgeInsets.symmetric(vertical: 8.0),
      child: DateTimeField(
